...
const primaryColors = ref([
    ...
    { name: 'yellow', palette: { 50: '#fffef0', 100: '#fffce0', 200: '#fff9c0', 300: '#fff5a0', 400: '#ffe866', 500: '#ffd700', 600: '#e6c200', 700: '#ccad00', 800: '#b39900', 900: '#998400', 950: '#806f00' } },
...
onMounted(() => {
    ...
    const surfaceColor = surfaces.value.find(c => c.name === layoutConfig.surface);
