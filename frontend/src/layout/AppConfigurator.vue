...
import { primaryColors, surfaces, getPresetExt, applyTheme } from '@/composables/useTheme'; // ✅ import
...
function onPresetChange() {
    ...
    $t().preset(presetValue).preset(getPresetExt(layoutConfig.primary)).surfacePalette(surfacePalette).use({ useDefaultOptions: true });
}
